...
7-Segment-Anzeige: `SA39-11GWA <https://www.mouser.de/ProductDetail/Kingbright/SA39-11GWA?qs=VdjlWU%2FzoOFiE%2FFTM5F11g%3D%3D>`_
an `nucleo_l432kc <https://www.st.com/resource/en/user_manual/dm00231744.pdf>`_.

.. image:: 7segment.png

.. image:: nucleo_l432kc.png

Bauen mit

    west build -p always -b nucleo_l432kc rbapp/sample_seg7

oder

    west build -p auto -b nucleo_l432kc rbapp/sample_seg7

Beobachten auf der seriellen Schnittstelle
